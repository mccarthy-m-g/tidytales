...
here::i_am("_posts/2021-06-15_demons-souls/demons_souls.Rmd")
...
meta() %>%
  meta_social(
    ...
    image = "https://tidytales.ca/posts/2021-06-15_demons-souls/images/demons_souls_twittercard.png",
...
<!-- ------------------------------------------------------------------------------------------ -->
(ref:logo) The Demon's Souls logo.

```{r logo, opts.label='fig.graphic', fig.cap="(ref:logo)"}
...
[Download](../../data/2021-06-15_demons-souls.csv) the data used in this article.
