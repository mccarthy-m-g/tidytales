...
Some example `.Rprofile`s can be found in [this thread on Stack Overflow](https://stackoverflow.com/questions/1189759/expert-r-users-whats-in-your-rprofile). Note that some of them contain code that could break the rule of thumb for reproducibility.
